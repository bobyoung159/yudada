...
import com.yupi.yudada.model.enums.AppScroingStrategyEnum;
...
public class AppServiceImpl extends ServiceImpl<AppMapper, App> implements AppService {
    ...
    public void validApp(App app, boolean add) {
        ...
        if (add) {
            ...
            AppScroingStrategyEnum scroingStrategyEnum = AppScroingStrategyEnum.getEnumByValue(scoringStrategy);
            ThrowUtils.throwIf(scroingStrategyEnum == null, ErrorCode.PARAMS_ERROR,"评分策略状态非法");
        }
        // 修改数据时，有参数则校验
        // todo 补充校验规则
